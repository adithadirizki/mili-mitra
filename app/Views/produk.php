        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <table id="table_produk" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Kode Produk</th>
...
<script>
    $(document).ready(function() {
        ...
        const thead = $("#table_produk thead")
        ...
        const tableProduk = $("#table_produk").on('processing.dt', function(e, settings, processing) {
